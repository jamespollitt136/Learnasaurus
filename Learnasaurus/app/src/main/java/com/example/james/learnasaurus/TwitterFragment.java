...
public class TwitterFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.twitter_webview_fragment, container, false);

        WebView twitter = (WebView)view.findViewById(R.id.twitterView);
        twitter.loadUrl("https://twitter.com/LearnasaurusApp");
